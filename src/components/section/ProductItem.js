export default function ProductItem({ name, subtitle, thumbnails }) {
    return (
      <div className="card w-[397px] h-[375px] bg-slate-50 shadow-xl px-4 pt-4 pb-5 hover:cursor-pointer">
